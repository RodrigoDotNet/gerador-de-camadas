    ...
    public class ListViewColumnSorter : IComparer
    {
        ...
        public int Compare(object x, object y)
        {
            ...
            int compareResult = ObjectCompare.Compare(
                    Convert.ChangeType(listviewX.SubItems[_columnToSort].Text, listviewX.SubItems[_columnToSort].Text.RetornaTipo()),
                    Convert.ChangeType(listviewY.SubItems[_columnToSort].Text, listviewX.SubItems[_columnToSort].Text.RetornaTipo())
                );
