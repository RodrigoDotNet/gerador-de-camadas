...
namespace DataDrain.ORM.DAL
{
    public class ArquivosObjetos
    {
        ...
        private static void GeraClassesORM(TipoObjetoBanco objOrm, List<DadosColunas> colunasObjeto, ParametrosCriarProjetos parametros)
        {
            ...
            var interfaceDAL = gerador.GerarInterfaceDAL(nomeArquivo, parametros.NameSpace, objOrm.TipoObjeto, objOrm.Parametros);
            ...
            File.WriteAllText(string.Format("{0}\\Interfaces\\IPersistence{1}.cs", parametros.CaminhoDestino, nomeArquivo), interfaceDAL);
